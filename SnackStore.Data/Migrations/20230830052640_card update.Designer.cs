...
namespace SnackStore.Data.Migrations
{
    ...
    [Migration("20230830052640_card update")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SnackStore.Data.Domains.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SnackStore.Data.Domains.Models.OrderDetails", b =>
                {
            ...
            modelBuilder.Entity("SnackStore.Data.Domains.Models.OrderHeader", b =>
                {
                    b.Property<int>("OrderHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SnackStore.Data.Domains.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("SnackStore.Data.Domains.Models.CartItem", b =>
                {
                    b.HasOne("SnackStore.Data.Domains.Models.Items", "MenuItem")
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SnackStore.Data.Domains.Models.ShoppingCart", null)
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("SnackStore.Data.Domains.Models.OrderDetails", b =>
                {
                    ...
                    b.HasOne("SnackStore.Data.Domains.Models.OrderHeader", null)
            ...
            modelBuilder.Entity("SnackStore.Data.Domains.Models.OrderHeader", b =>
                {
                    b.HasOne("SnackStore.Data.Domains.Models.ApplicationUser", "User")
                        .WithMany()
